...
//	_AT_SAVE_SETTING,          //BC660 k dung  lenh nay

	//Init TCP/IP
	_AT_CHECK_ATTACH,		//17
	_AT_CHECK_RSSI,			//18
	_AT_DIS_DEEP_SLEEP,		//19
    _AT_DISABLE_PSM,        //Test
	_AT_GET_RTC,			//20
	//Open TCP socket
	_AT_TCP_OPEN_1,			//21
	_AT_TCP_OPEN_2,			//22
...
const sCommand_Sim_Struct aSimStep[] =
{
	...
	{_AT_DISPLAY_CMD, 	    "ATE0\r",			"OK",			_Cb_AT_Success,   	_Cb_AT_Failure	},
	{_AT_CHECK_SIM,         "AT+CPIN?\r",		"OK",           _Cb_AT_CHECK_SIM,   _Cb_AT_Failure	},
	{_AT_CHECK_RSSI, 		"AT+CSQ\r", 		"CSQ:",         _Cb_AT_CHECK_RSSI,  _Cb_AT_Failure	},
	...
	{_AT_SET_BAND_3, 		"AT+QBAND=1,3\r",	"OK",			_Cb_AT_SET_BAND_3,  _Cb_AT_Failure	},
	...
	{_AT_GET_RTC, 			"AT+CCLK?\r",		"+CCLK:", 		_Cb_AT_GET_CLOCK,   _Cb_AT_Failure	},
    ...
    {_AT_EN_WAKEUP_URC,     "AT+QNBIOTEVENT=1,1\r", "OK",       _Cb_AT_Success,   	_Cb_AT_Failure	},
    ...
    {_AT_TCP_CONFIG_VIEW,	"AT+QCFG=\"dsevent\",1\r",	    	"OK", _Cb_AT_Success,   _Cb_AT_Failure	},
    {_AT_TCP_CONFIG_SHOW,	"AT+QCFG=\"wakeupRXD\",1\r",	    "OK", _Cb_AT_Success,   _Cb_AT_Failure	},
    
    {_AT_CHECK_CREG, 		 "AT+CEREG?\r",     "CEREG: 0,|1|5",    _Cb_AT_Success,   _Cb_AT_Failure	},
	...
	{_AT_MQTT_CONN_2, 		"\r",	    		"4,\"20020000\"",       _Cb_MQTT_CONNECT_2,   _Cb_AT_Failure	},  //4,"20020000"
	...
	{_AT_MQTT_PUB_2, 		"\r",	   			"SEND OK" ,   		    _Cb_MQTT_PUBLISH_2,   _Cb_AT_Failure	},  //"4,40020001"  "SEND OK"

	{_AT_MQTT_PUB_FB_1, 	NULL,				NULL,                   _Cb_MQTT_PUBLISH_1,   _Cb_AT_Failure	},
	{_AT_MQTT_PUB_FB_2, 	"\r",	   			"4,\"40020001\"",       _Cb_MQTT_PUBLISH_2,   _Cb_AT_Failure	},  // 4,"40020001"
...
{
	{SIM_URC_RESET_SIM900,		NULL, 	"NORMAL POWER DOWN", 		_Cb_AT_Success,   	NULL	},// OK +QNBIOTEVENT: "ENTER PSM"
    ...
    {SIM_URC_RECEIV_SERVER, 	NULL,	"414d492f",			        _Cb_RECEIV_SERVER,  NULL	},   //"AMI/"   
};
...
/*
    Module BC660 Power:
        + Giu chan Boot va Reset ơ muc Thap
