...
void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = FB_Bot_Elevator_Pin|FB_Top_Elevator_Pin;
  ...
  /*Configure GPIO pins : PCPin PCPin PCPin PCPin
                           PCPin PCPin */
  GPIO_InitStruct.Pin = FB_Pos_Elevator_Pin|Encoder_C2_Pin|Encoder_C1_Pin|FB_Motor_2_Pin
                          |FB_Motor_3_Pin|FB_Motor_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : PDPin PDPin PDPin PDPin
                           PDPin PDPin */
  GPIO_InitStruct.Pin = FB_Motor_5_Pin|FB_Motor_6_Pin|FB_Motor_7_Pin|FB_Motor_8_Pin
                          |FB_Motor_9_Pin|FB_Motor_10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
