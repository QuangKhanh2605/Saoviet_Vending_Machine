...
//			id ENUM				  kind process			     str Received
        ...
        {_ON_PCBOX,             _fON_PCBOX,                 {(uint8_t*)"at+onpcbox",10}},       //Ex: "at+onpcbox"
        {_OFF_PCBOX,            _fOFF_PCBOX,                {(uint8_t*)"at+offpcbox",11}},      //Ex: "at+offpcbox"
        
        {_APP_FIX_MOTOR,        _fAPP_FIX_MOTOR,            {(uint8_t*)"at+testmotor=",13}},     //Ex: "at+fixmotor=1"
        {_APP_PUSH_MOTOR,       _fAPP_PUSH_MOTOR,           {(uint8_t*)"at+purchase=",12}},     //Ex: "at+purchase=1 1"
        ...
        {_TEST_LOCK_MAGNETIS,   _fTEST_LOCK_MAGNETIS,       {(uint8_t*)"at+lockmagnetis",15}},
...
void        _fTEST_LOCK_MAGNETIS (sData *strRecei, uint16_t Pos)
{
  if(sParamDelivery.StateHanlde == DELIVERY_FREE)
  {
    fevent_enable(sEventAppDelivery, _EVENT_TEST_LOCK_MAGNETIS);
    DCU_Respond(PortConfig, (uint8_t*)"OK\r\n", 4, 0);
  }
  else
  {
