...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, Toggle_Reset_Pin|SIM_RESET_Pin|SIM_ON_OFF_Pin|RESET_USB_Pin
                          |Layer_6_Pin|Layer_5_Pin|Layer_4_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, RS485_TXDE_Pin|SIM_PWR_KEY_Pin|Layer_7_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(FLASH_RESET_GPIO_Port, FLASH_RESET_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, FLASH_CS_Pin|Layer_3_Pin|Layer_2_Pin|Layer_1_Pin
  ...
  GPIO_InitStruct.Pin = RS485_TXDE_Pin|Layer_7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : PCPin PCPin */
  GPIO_InitStruct.Pin = SIM_RESET_Pin|SIM_ON_OFF_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : PDPin PDPin PDPin PDPin
                           ...
                           PDPin */
  GPIO_InitStruct.Pin = FLASH_CS_Pin|Layer_3_Pin|Layer_2_Pin|Layer_1_Pin
                          |Slot_1_Pin|Slot_2_Pin|Slot_3_Pin|Slot_4_Pin
                          |Slot_5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
