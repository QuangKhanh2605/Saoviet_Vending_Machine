...
#define NUMBER_MAX_BUFFER           50

#define TIME_SEND_TSVH              5*60000
#define TIME_RESET_WDG              250
...
#define TIME_WAIT_RESET_PC_BOX      60*1000
...
typedef enum
{
    ...
    _EVENT_QUEUE_RESPOND_PCBOX,
    _EVENT_HANDLE_RESPOND_ERROR,
