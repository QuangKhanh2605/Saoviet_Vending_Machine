...
{   
  ...
  { _EVENT_FREE_ELEVATOR_LOWER,       1, 5, 15000,                      fevent_free_elevator_lower},
  ...
  { _EVENT_FREE_LOCK_MAGNETIS,        1, 5, 2000,                       fevent_free_lock_magnetis},
};
...
void Save_TimeLockMagnetis(void)
{
    ...
    eFlash_S25FL_BufferWrite(write, EX_FLASH_ADDR_TIME_LOCK_MAGNETIS, 12);
}

void Init_TimeLockMagnetis(void)
{
    uint8_t read[10] = {0};
    eFlash_S25FL_BufferRead(read, EX_FLASH_ADDR_TIME_LOCK_MAGNETIS , 12);
