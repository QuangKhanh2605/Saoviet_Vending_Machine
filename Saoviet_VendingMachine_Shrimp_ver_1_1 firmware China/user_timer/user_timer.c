...
/*
 * Start 1 object timer
 * Nếu như timer đó đã tồn tại trong list timer chạy thì sẽ bị bỏ qua.
 * */
...
/*
 * Func: Start timer kem them option set period cho object đó
 * */
...
/*
 * Func: Set lai period 1 timer dang chay. Neu timer chua dc khoi chay thi se khong set
 * */
...
/*
 * Thuc hien callback cua timer va hen alarm tiep theo:
 *
