...
#define EX_FLASH_ADDR_VALUE_TEMP_CALIB  0x0FB000
#define EX_FLASH_ADDR_TIME_LOCK_MAGNETIS 0x0FC000
...
#define FLASH_RESET_OFF         HAL_GPIO_WritePin(FLASH_RESET_GPIO_Port, FLASH_RESET_Pin, GPIO_PIN_RESET)    
#define FLASH_RESET_ON          HAL_GPIO_WritePin(FLASH_RESET_GPIO_Port, FLASH_RESET_Pin, GPIO_PIN_SET)      
