...
sEvent_struct               sEventAppRs485[]=
{
  ...
  {_EVENT_RS485_TRANSMIT,           0, 0, 1000,             fevent_rs485_transmit},
...
//    eFlash_S25FL_BufferWrite(write, EX_FLASH_ADDR_ID_SLAVE_485, 2);
    Write_Mem_Parameter_Var(EX_FLASH_ADDR_ID_SLAVE_485, write, 2);
    return 1;
}
...
//    eFlash_S25FL_BufferRead(read, EX_FLASH_ADDR_ID_SLAVE_485 , 2);
    Read_Mem_Parameter_Var(EX_FLASH_ADDR_ID_SLAVE_485, read, 2);
