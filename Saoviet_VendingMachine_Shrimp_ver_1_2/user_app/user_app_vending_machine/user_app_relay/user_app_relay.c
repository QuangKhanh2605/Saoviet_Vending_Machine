...
static GPIO_TypeDef*    RELAY_PORT[NUMBER_RELAY] = {RELAY_V1_PORT, 
                                                    RELAY_SCREEN_PORT, 
...
static uint16_t         RELAY_PIN[NUMBER_RELAY] = {RELAY_V1_PIN, 
                                                   RELAY_SCREEN_PIN, 
...
//    eFlash_S25FL_BufferWrite(aWrite, EX_FLASH_ADDR_STATUS_RELAY, length);
    ...
    Write_Mem_Parameter_Var(EX_FLASH_ADDR_STATUS_RELAY, aWrite, length);
}
...
//    eFlash_S25FL_BufferRead(aRead, EX_FLASH_ADDR_STATUS_RELAY, 16);
    Read_Mem_Parameter_Var(EX_FLASH_ADDR_STATUS_RELAY, aRead, 16);
...
//        eFlash_S25FL_BufferWrite(write, EX_FLASH_ADDR_TIME_RELAY_WARM, length);
        ...
        Write_Mem_Parameter_Var(EX_FLASH_ADDR_TIME_RELAY_WARM, write, length);
...
//    eFlash_S25FL_BufferRead(aRead, EX_FLASH_ADDR_TIME_RELAY_WARM, 3);
    Read_Mem_Parameter_Var(EX_FLASH_ADDR_TIME_RELAY_WARM, aRead, 3);
...
void Relay_Debug(uint8_t State_Debug, uint8_t KindRelay, uint8_t Status)
{
    ...
    if(Status == ON_RELAY)
    {
      UTIL_Printf_Str(DBLEVEL_M, "user_app_relay: ON Relay: ");
    }
    else
    {
      UTIL_Printf_Str(DBLEVEL_M, "user_app_relay: OFF Relay: ");
    }
    
    switch(KindRelay)
    {
        case RELAY_ELEVATOR:
           UTIL_Printf_Str(DBLEVEL_M, "ELEVATOR\r\n"); 
           break;
           
        case RELAY_SCREEN:
           UTIL_Printf_Str(DBLEVEL_M, "SCREEN \r\n"); 
           break;
           
        case RELAY_FRIDGE_COOL:
           UTIL_Printf_Str(DBLEVEL_M, "FRIDGE COOL \r\n"); 
           break;
           
        case RELAY_ALARM:
           UTIL_Printf_Str(DBLEVEL_M, "ALARM \r\n"); 
           break;
           
        case RELAY_FRIDGE_HEAT:
           UTIL_Printf_Str(DBLEVEL_M, "FRIDGE HEAT \r\n"); 
           break;
           
        case RELAY_LAMP:
           UTIL_Printf_Str(DBLEVEL_M, "LAMP \r\n"); 
           break;
           
        case RELAY_WARM:
           UTIL_Printf_Str(DBLEVEL_M, "WARM \r\n"); 
           break;
